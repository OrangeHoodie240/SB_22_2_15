...
playstore=# SELECT app_name, reviews, min_installs, min_installs / reviews AS proportion FROM analytics WHERE min_installs / reviews  = (SELECT MAX(min_installs/reviews) FROM analytics);